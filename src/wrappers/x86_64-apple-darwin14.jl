# Autogenerated wrapper script for opusfile_jll for x86_64-apple-darwin14
...
const libopusfile_splitpath = ["lib", "libopusfile.0.dylib"]
...
const libopusfile = "@rpath/libopusfile.0.dylib"


# Relative path to `libopusurl`
const libopusurl_splitpath = ["lib", "libopusurl.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libopusurl = "@rpath/libopusurl.0.dylib"
