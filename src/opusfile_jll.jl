...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import opusfile_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4fb77979-f048-53ce-ae57-a45249826a33"))
platforms = [Pkg.Artifacts.unpack_platform(e, "opusfile", artifacts_toml) for e in artifacts["opusfile"]]
...
if best_platform === nothing
    @debug("Unable to load opusfile; unsupported platform $(triplet(platform_key_abi()))")
else
